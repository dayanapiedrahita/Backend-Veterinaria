...
from schemas.cita_vacunacion_schema import CitaVacunacionCreate, CitaVacunacionUpdate, CitaVacunacionResponse
...
def actualizar_cita(cita_id: int, cita: CitaVacunacionUpdate, db: Session = Depends(get_db)):

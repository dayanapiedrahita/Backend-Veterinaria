    ...
    try:
        while True:
            ...
            if opt == "1":
                ...
                data = VacunaCreate(
                    nombre=nombre, fabricante=fabricante, dosis_requeridas=dosis
                )
                ...
                data = ClienteRegistro(
                    nombre=nombre, telefono=telefono, direccion=direccion, email=email
                )
                ...
                try:
                    ...
                    print(
                        f"Error: Fecha inválida. Por favor usa el formato YYYY-MM-DD. Detalle: {e}"
                    )
                ...
                try:
                    ...
                    print(
                        f"Error: Entrada inválida. Verifica los formatos (fecha YYYY-MM-DD HH:MM:SS). Detalle: {e}"
                    )

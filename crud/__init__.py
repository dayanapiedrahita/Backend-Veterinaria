...
__all__ = [
    "get_usuarios", "get_usuario_by_id", "register_cliente", "register_veterinario", "login_usuario",
    "create_usuario", "update_usuario", "delete_usuario",
    "get_clientes", "get_cliente", "update_cliente", "delete_cliente",
    "get_veterinarios", "get_veterinario", "update_veterinario", "delete_veterinario",
